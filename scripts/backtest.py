...
# portfolio of stocks
#portfolio_stocks = ["IJGXX","JCPB","BBAG","BBUS","BBIN","BBMC","BBSC","JEMA","JAVA","JGRO", "JVAL", "JMOM","JQUA",]
portfolio_stocks = ["IJGXX","JCPB","BBAG","BBUS","BBIN","BBMC","BBSC","JEMA","JAVA","JGRO",]
...
#colors = ['tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:gray','tab:red',"k"]
